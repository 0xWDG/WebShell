...
extension WSViewController {
    ...
    @objc func _quit(_ Sender: AnyObject) {
        exit(0)
    }
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _doNothing(_ Sender: AnyObject) {
        // _doNothing
    }
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _debugNewWindow(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _debugDumpArguments(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func __sendNotifications(_ Sender: AnyObject) {
        // Minimize app
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _WWCDT(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _reportThisPage(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Notes Issue: #39
     */
    @objc func _printThisPage(_ Sender: AnyObject? = nil) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _goBack(_ Sender: AnyObject) {
        if mainWebview.canGoBack {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _goForward(_ Sender: AnyObject) {
        if mainWebview.canGoForward {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func _reloadPage(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func createNewInstance(_ Sender: AnyObject) {
    ...
    /**
     ...
     - Parameter Sender: Anyobject
     */
    @objc func downloadFileWithURL(_ Sender: AnyObject) {
